...
\documentclass[10pt,a4paper,ragged2e,withhyper]{../classes/altacv}
...
%% for your publication list
\input{./config/pubs-num.cfg}

%% sample.bib contains your publications
\addbibresource{sample.bib}

\begin{document}
\name{Luis Gerardo Manrique Cardona}
\tagline{Your Position or Tagline Here}
%% You can add multiple photos on the left or right
\photoR{2.8cm}{./static/profile}
...
\cvevent{Software developer}{Truora}{06 2019 -- 06 2022}{Colombia}
\begin{itemize}
